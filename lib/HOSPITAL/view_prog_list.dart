...
import 'package:sih2024/HOSPITAL/view_prog_alldetails.dart';
...
class EventsListPagess_hospital extends StatefulWidget {
  @override
  _EventsListPagess_hospitalState createState() => _EventsListPagess_hospitalState();
}

class _EventsListPagess_hospitalState extends State<EventsListPagess_hospital> {
  final TextEditingController _searchController = TextEditingController();
  final FocusNode _searchFocusNode = FocusNode();
  String _searchQuery = '';
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EventDetailPages_hospital(event: event),
                                  ),
                                );
                              },
                            ),
